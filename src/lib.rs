// src/lib.rs
/*
 * Core library for MachineGenius
 */
...
#[derive(Debug)]
pub struct MachineGeniusProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MachineGeniusProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MachineGenius processing");
    
    let mut processor = MachineGeniusProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MachineGeniusProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MachineGeniusProcessor::new(false);
